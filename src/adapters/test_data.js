...
export const defaultWorkingdata = [{
  ...
  full_name: "Donny Novak",
  actions: [actions.EMAIL_VERIFICATION, actions.ID_VERIFICATION, actions.ID_VERIFICATION]
}];
...
function populateDetail(record) {
  return { ...record,
    ...
    currriculum_explanation: "It is an Interesting curriculum that helps growing child especially in Reading and number work."
  };
}
